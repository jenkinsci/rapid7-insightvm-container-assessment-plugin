...
import com.rapid7.sdlc.plugin.ruleset.property.CriticalVulnerabilities;
...
public class CriticalVulnerabilitiesDescribable extends ThresholdRuleDescribable {
  private final String action;
  private final String threshold;
  private final CriticalVulnerabilities rule;

  @DataBoundConstructor
  public CriticalVulnerabilitiesDescribable(String action, String threshold) {
    this.action = action;
    this.threshold = threshold;
    this.rule = new CriticalVulnerabilities(Integer.parseInt(threshold));
  }
  ...
  @Extension
  @Symbol("criticalVulnerabilities")
  public static class DescriptorImpl extends Descriptor<ThresholdRuleDescribable> {
    @Nonnull
    @Override
    public String getDisplayName() {
      return Messages.ContainerAssessmentBuilder_CriticalVulnerabilitiesRule();
    }
