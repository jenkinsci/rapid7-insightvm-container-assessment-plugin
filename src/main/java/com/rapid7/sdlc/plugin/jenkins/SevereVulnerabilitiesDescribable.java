...
import com.rapid7.sdlc.plugin.ruleset.property.SevereVulnerabilities;
...
public class SevereVulnerabilitiesDescribable extends ThresholdRuleDescribable {
  private final String action;
  private final String threshold;
  private final SevereVulnerabilities rule;

  @DataBoundConstructor
  public SevereVulnerabilitiesDescribable(String action, String threshold) {
    this.action = action;
    this.threshold = threshold;
    this.rule = new SevereVulnerabilities(Integer.parseInt(threshold));
  }
  ...
  @Extension
  @Symbol("severeVulnerabilities")
  public static class DescriptorImpl extends Descriptor<ThresholdRuleDescribable> {
    @Nonnull
    @Override
    public String getDisplayName() {
      return Messages.ContainerAssessmentBuilder_SevereVulnerabilitiesRule();
    }
