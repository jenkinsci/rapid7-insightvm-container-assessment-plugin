...
import com.rapid7.sdlc.plugin.ruleset.property.VulnerablePackageName;
...
public class VulnerablePackageNameDescribable extends NameRuleDescribable {
  private final String action;
  private final String contains;
  private final VulnerablePackageName rule;

  @DataBoundConstructor
  public VulnerablePackageNameDescribable(String action, String contains) {
    this.action = action;
    this.contains = contains;
    this.rule = new VulnerablePackageName(contains);
  }
  ...
  @Extension
  @Symbol("vulnerablePackageName")
  public static class DescriptorImpl extends Descriptor<NameRuleDescribable> {
    @Nonnull
    @Override
    public String getDisplayName() {
      return Messages.ContainerAssessmentBuilder_VulnerablePackageNameRule();
    }
