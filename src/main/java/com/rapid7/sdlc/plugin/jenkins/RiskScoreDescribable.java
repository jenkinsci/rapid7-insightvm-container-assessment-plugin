...
import com.rapid7.sdlc.plugin.ruleset.property.RiskScore;
...
public class RiskScoreDescribable extends ThresholdRuleDescribable {
  ...
  private final RiskScore rule;

  @DataBoundConstructor
  public RiskScoreDescribable(String action, String threshold) {
    this.action = action;
    this.threshold = threshold;
    this.rule = new RiskScore(Double.parseDouble(threshold));
  }
  ...
  public static class DescriptorImpl extends Descriptor<ThresholdRuleDescribable> {
    ...
    public String getDisplayName() {
      return Messages.ContainerAssessmentBuilder_RiskScoreRule();
    }
